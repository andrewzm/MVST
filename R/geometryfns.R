...
partition_section <- function(points,nrep) {
  ...
  #' @param numcolours the maximum number of colours to try out. The function gives an error if this is exceeded.
  ...
  #' @export
  colour_graph_bfs <- function(adj.matrix,numcolours,startnode=1) {
